...
function saveToFavorites(movie) {
    ...
    // Uppdatera listan med favoriter direkt
    displayFavorites();
}
...
function displayFavorites() {
    ...
    favoritesContainer.innerHTML = ''; // Rensa tidigare innehåll
...
function removeFromFavorites(movie) {
    let favorites = JSON.parse(localStorage.getItem('favorites')) || [];
    favorites = favorites.filter(fav => fav.id !== movie.id); // Filtrera bort filmen som ska tas bort
    localStorage.setItem('favorites', JSON.stringify(favorites)); // Spara den uppdaterade listan
...
function displayFavorites() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        displayFavorites(); // Visa favoriter när sidan laddas
    });
